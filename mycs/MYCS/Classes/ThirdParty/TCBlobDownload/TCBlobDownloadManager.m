...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.defaultDownloadPath = [[NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES)lastObject] stringByAppendingPathComponent:@"Videos"];
        [self setMaxConcurrentDownloads:1];
    }
    return self;
}
