...
+(void)showPickerViewInView:(UIView *)view
  ...
  [[self sharedView] initializePickerViewInView:view
                                      withArray:strings
                                    withOptions:options isVideo:NO];
...
+(void)showPickerViewInVideoView:(UIView *)view
                withObjects:(NSArray *)objects
                withOptions:(NSDictionary *)options
    objectToStringConverter:(NSString *(^)(id))converter
                 completion:(void (^)(id))completion {
    ...
    [[self sharedView] initializePickerViewInView:view
                                        withArray:objects
                                      withOptions:options isVideo:YES];
    [[self sharedView] setPickerHidden:NO callBack:nil];
    [view addSubview:[self sharedView]];
...
{
    [self setPickerCancelHidden:YES callBack:nil];
...
-(void)setPickerCancelHidden: (BOOL)hidden
...
-(void)initializePickerViewInView: (UIView *)view
                      ...
                      withOptions: (NSDictionary *)options isVideo:(BOOL)isVideo{
  ...
  if (toolbarBackgroundColor==nil) {
    toolbarBackgroundColor = [UIColor colorWithRed:71.0/255 green:193.0/255 blue:169.0/255 alpha:1];
  }
  ...
  if (pickerViewFont==nil) {
    _pickerViewFont = [UIFont systemFontOfSize:15];
  }
...
//  [_pickerTopBarView setBackgroundColor:[UIColor whiteColor]];
  ...
  if (toolbarImage!=nil) {
    ...
    _pickerViewBarButtonItem = [[UIBarButtonItem alloc]initWithTitle:@"确定" style:UIBarButtonItemStyleDone target:self action:@selector(dismiss)];
    UIBarButtonItem * cancel = [[UIBarButtonItem alloc]initWithTitle:@"取消" style:UIBarButtonItemStyleDone target:self action:@selector(dismissWithCancel)];
    
    if (isVideo) {
          UIBarButtonItem *flexibleSpace1 = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:nil action:nil];
                  UIBarButtonItem *flexibleSpace2 = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:nil action:nil];
    UIBarButtonItem * title = [[UIBarButtonItem alloc]initWithTitle:@"选择章节" style:UIBarButtonItemStyleDone target:nil action:nil];
        [title setTintColor:[UIColor whiteColor]];
        _pickerViewToolBar.items = @[cancel,flexibleSpace1,title, flexibleSpace2,_pickerViewBarButtonItem];
  ...
  [_pickerViewBarButtonItem setTintColor:[UIColor whiteColor]];
  ...
  */
  ...
  //Add pickerView
  _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0.0,44, [UIScreen mainScreen].bounds.size.width, 216.0)];
...
//    [customPickerView addSubview:patternImageView];
    ...
    [pickerViewLabel setFont:[UIFont systemFontOfSize:15]];
