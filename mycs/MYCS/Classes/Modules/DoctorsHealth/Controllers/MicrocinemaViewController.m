...
@interface MicrocinemaViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MicrocinemaViewController
...
#pragma mark - 加载表格轮播图数据
-(void)getBannarData
{
    
    [DoctorsHealthList getBannarWithCategory:@"3" Success:^(NSArray *lists) {
...
-(void)loadNewData
{
    ...
    [DoctorsHealthList getListsWithCategory:@"3" itemType:self.itemType diseaseCategoryId:self.diseaseCategoryId page:1 Success:^(NSArray *lists) {
...
-(void)loadMoreData
{
    ...
    [DoctorsHealthList getListsWithCategory:@"3" itemType:self.itemType diseaseCategoryId:self.diseaseCategoryId page:page Success:^(NSArray *lists) {
