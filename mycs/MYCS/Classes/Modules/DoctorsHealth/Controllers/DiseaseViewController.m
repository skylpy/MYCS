...
@interface DiseaseViewController ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate>
...
#pragma mark - 用于筛选不同的疾病 diseaseCategoryId 疾病类别ID
-(void)loadDataWithDiseaseCategoryId:(NSString *)diseaseCategoryId
{

    self.diseaseCategoryId = diseaseCategoryId;
...
-(void)getBannarData
{
    [DoctorsHealthList getBannarWithCategory:@"1" Success:^(NSArray *lists)
    {
...
-(void)loadNewData
{
    ...
    [DoctorsHealthList getListsWithCategory:@"1" itemType:self.itemType diseaseCategoryId:self.diseaseCategoryId page:1 Success:^(NSArray *lists) {
...
-(void)loadMoreData
{
    ...
    [DoctorsHealthList getListsWithCategory:@"1" itemType:self.itemType diseaseCategoryId:self.diseaseCategoryId page:page Success:^(NSArray *lists) {
