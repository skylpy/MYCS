...
-(void)getBannarData
{
    ...
    [DoctorsHealthList getBannarWithCategory:@"4" Success:^(NSArray *lists) {
...
//        list = [NSArray arrayWithObject:imagePath];
        return;
    }
...
-(void)loadNewData
{
    ...
    [DoctorsHealthList getListsWithCategory:@"4" itemType:self.itemType diseaseCategoryId:self.diseaseCategoryId page:1 Success:^(NSArray *lists) {
...
-(void)loadMoreData
{
    ...
    [DoctorsHealthList getListsWithCategory:@"4" itemType:self.itemType diseaseCategoryId:self.diseaseCategoryId page:page Success:^(NSArray *lists) {
