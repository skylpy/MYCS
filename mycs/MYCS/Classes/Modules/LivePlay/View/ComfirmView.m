...
+ (instancetype)showInView:(UIView *)superView cancelItemWith:(ModelComfirm *)cancelModel dataSource:(NSArray *)dataSource actionBlock:(void (^)(ComfirmView *, NSInteger))actionBlock {
...
- (void)addConstsToTitleLabel {
    ...
    NSArray *hConsts = [NSLayoutConstraint constraintsWithVisualFormat:hVFL options:0 metrics:nil views:NSDictionaryOfVariableBindings(label)];
    NSArray *vConsts = [NSLayoutConstraint constraintsWithVisualFormat:vVFL options:0 metrics:nil views:NSDictionaryOfVariableBindings(label)];
